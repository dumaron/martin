...
def main_render(request, project_id):
	...
	return render(
		request,
		'project_detail_page/project_detail.html',
...
def add_task_form(request, project_id):
	project = get_object_or_404(Project, pk=project_id)
	return render(request, 'project_detail_page/add_task_form.html', {'project': project})
...
def create_task(request, project_id):
	...
	if description:
		...
		return render(request, 'project_detail_page/task_item.html', {'task': task})
...
def add_subproject_form(request, project_id):
	project = get_object_or_404(Project, pk=project_id)
	return render(request, 'project_detail_page/add_subproject_form.html', {'project': project})
...
def create_subproject(request, project_id):
	...
	if title:
		...
		return render(request, 'project_detail_page/subproject_item.html', {'subproject': subproject})

	return render(request, 'project_detail_page/add_subproject_form.html', {'project': parent_project})
