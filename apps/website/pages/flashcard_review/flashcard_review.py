...
page = Page(name='flashcard_review_page', base_route='knowledge/flashcards/review')
...
def main_render(request):
	...
	if flashcard:
		...
		# That will likely require a new entity, something like `ReviewSession`. Out of scope for now.
		context = {
			'flashcard': None,
