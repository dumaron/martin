...
def main_render(request):
	form = InboxForm()
	return render(request, 'capture_inbox_page/inbox_create.html', {'form': form, 'creation_success': False})
...
def capture_inbox_item(request):
	...
	if form.is_valid():
		...
		return render(
			request, 'capture_inbox_page/inbox_create.html', {'form': InboxForm(), 'creation_success': True}
		)
	return render(request, 'capture_inbox_page/inbox_create.html', {'form': form, 'creation_success': False})
